...
This repository contains the elements for data analysis of enviornmental data using Github, R, and Rmarkdown.
...
* All data is included in the subfolders inside the `data` folder.
* All code is included in `code` folder or subfolders.
* All results (figures, tables, computed values) are included in `results` folder or subfolders.
* All products (manuscripts, supplement, presentation slides, web apps, etc.) are included in `products` subfolders.
